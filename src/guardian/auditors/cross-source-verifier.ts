...
import type { SourcedClaim, ConfidenceLevel } from '../../types/common-types.js';

type LLMAdapter = LLMService; // Alias for compatibility
type SourceQualityScore = any; // TODO: Define proper type
...
Provide analysis in JSON:
{
  ...
  "reasoning": "<detailed explanation>"
    ...
    try {
      const response = await this.llm.prompt(prompt, { temperature: 0.3 });
